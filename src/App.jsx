...
function App() {
  const songsData = [
    ...
    },
    {
      ...
      singers: "Sid Sriram",
      thumbnail:
        "https://cdn.telugu360.com/wp-content/uploads/2023/09/maxresdefault-9.jpg",
      src: "https://samplelib.com/lib/preview/mp3/sample-3s.mp3",
    },
    {
      id: 3,
      ...
      singers: "DJ Tillu",
      thumbnail:
        "https://m.media-amazon.com/images/M/MV5BYTA0NDI5ZWUtZWMyMy00YjUyLWFkYTYtZDdlMjQ5YmVhNmY0XkEyXkFqcGc@._V1_.jpg",
      src: "https://samplelib.com/lib/preview/mp3/sample-3s.mp3",
    },
    {
      id: 4,
      ...
      singers: "DSP",
      thumbnail:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJtwdI46Fy3Cu_p_2K0mFGaBjg8G1W1fr5RQ&s",
      src: "https://samplelib.com/lib/preview/mp3/sample-3s.mp3",
    },
  ];
